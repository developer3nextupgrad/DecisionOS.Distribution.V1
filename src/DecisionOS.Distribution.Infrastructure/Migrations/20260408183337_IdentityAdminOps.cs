...
{
    /// <inheritdoc />
    public partial class IdentityAdminOps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportRuns_TenantId_PeriodEnd_SourceFingerprint",
                table: "ImportRuns",
                columns: new[] { "TenantId", "PeriodEnd", "SourceFingerprint" });
